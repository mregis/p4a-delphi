object Frm_Dig_Previdencia_Bradesco: TFrm_Dig_Previdencia_Bradesco
  Left = 5
  Top = 52
  ActiveControl = ScrollBox1
  BorderIcons = []
  Caption = 'Digita'#231#227'o de Previdencia Bradesco'
  ClientHeight = 437
  ClientWidth = 777
  Color = clBtnFace
