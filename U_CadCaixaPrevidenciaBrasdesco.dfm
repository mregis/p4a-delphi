object FrmCadCaixaPrevidenciaBrasdesco: TFrmCadCaixaPrevidenciaBrasdesco
  Left = 120
  Top = 55
  ActiveControl = ScrollBox1
  BorderIcons = []
  Caption = 'Cadastro de Caixa Para Digita'#231#227'o da Previdencia Bradesco'
  ClientHeight = 458
  ClientWidth = 701
  Color = clBtnFace
  ...
  object ScrollBox1: TScrollBox
    ...
    object DBLkSucursal: TDBLookupComboBox
      Left = 436
      Top = 16
      Width = 223
      Height = 21
      KeyField = 'cg41_codsuc'
      ListField = 'cg41_codsuc'
      ListSource = Dm.DtsCga41
      TabOrder = 9
    end
