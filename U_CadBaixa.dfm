object FrmCadBaixa: TFrmCadBaixa
  Left = 194
  Top = 131
  ActiveControl = ScrollBox1
  BorderIcons = []
  Caption = 'Cadastro de Baixa'
  ClientHeight = 350
  ClientWidth = 384
  Color = clBtnFace
    ...
    object DBGrid1: TDBGrid
      ...
      Columns = <
        ...
        item
          ...
          Title.Caption = 'Codigo de Retorno'
          Width = 97
          Visible = True
        end>
    end
