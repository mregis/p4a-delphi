object FrmMkcep: TFrmMkcep
  Left = 161
  Top = 123
  ActiveControl = ScrollBoxmk
  BorderIcons = []
  Caption = 'Cadastro de Faixa de Cep'
  ClientHeight = 316
  ClientWidth = 477
  Color = clBtnFace
  ...
  object ScrollBoxmk: TScrollBox
    ...
    object dblcFilial: TDBLookupComboBox
      Left = 120
      Top = 22
      Width = 145
      Height = 21
      ...
      ListSource = Dm.dtsCga107
      TabOrder = 12
      OnClick = dblcFilialClick
    end
