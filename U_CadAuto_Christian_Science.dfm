object FrmCadAutoChristianSciense: TFrmCadAutoChristianSciense
  Left = 147
  Top = 92
  ActiveControl = ScrollBox1
  BorderIcons = []
  Caption = 'Cadastro Automatico de Solicita'#231#245'es da Revista Christian Science'
  ClientHeight = 553
  ClientWidth = 800
  Color = clBtnFace
