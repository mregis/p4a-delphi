...
begin
  ...
  AbreBaixa(0);
  FrmExtContaCorrentePoupanca.Caption:='Baixa de extratos Conta Corrente Poupança';
  FrmExtContaCorrentePoupanca.ShowModal;
  setfocus;
end;
...
begin
  ...
  AbreBaixa(0);
  FrmExtContaCorrentePoupanca.Caption:='Bradesco Adm. Consórcio';
  FrmExtContaCorrentePoupanca.ShowModal;
  setfocus;
...
begin
  ...
  FrmRetornoExtratos.Caption := 'Retorno: Extrato Conta Corrente Poupança';
  FrmRetornoExtratos.ShowModal;
  setfocus;
end;
...
begin
  ...
  AbreBaixa(0);
  FrmExtContaCorrentePoupanca.Caption:='Baixa DRC - Aviso de Cobrança - CLLP';
...
begin
// Na tela abaixo não foi feita a conversão

{    Application.CreateForm(TfrmMkmakro,frmMkmakro);
//Abre a tabela Edição em ordem
    dm.SqlCga105.Close;
    dm.SqlCga105.Sql.Clear;
    dm.SqlCga105.Sql.Add('select * from cga105cadedi order by numedi');
    dm.SqlCga105.ExecSql;
    dm.SqlCga105.Open;
//Abre a Tabela Divisão
    dm.SqlCga106.Open;
...
begin
  ...
  FrmExtContaCorrentePoupanca.Caption:='Baixa de extratos Cartão Bradesco';
  FrmExtContaCorrentePoupanca.ShowModal;
  setfocus;
end;
...
begin
  ...
  FrmRetornoExtratos.Caption := 'Retorno: Extrato Cartão Bradesco';
  FrmRetornoExtratos.ShowModal;
  setfocus;
end;
...
begin
 ...
 { Esse procedimento pega as teclas abaixo como
   ...
   Isso pode ser possível usando a variavel TForm
...
Begin
  ...
  FrmExtContaCorrentePoupanca.Caption:='Saída de Tokens';
  FrmExtContaCorrentePoupanca.EdRemessa.MaxLength  := 25;
  FrmExtContaCorrentePoupanca.EdRemessa2.MaxLength := 35;
  FrmExtContaCorrentePoupanca.Panel5.Caption       := 'Agência';
...
begin
  ...
  FrmRetornoExtratos.Caption := 'Retorno: Cartão Fatura';
  FrmRetornoExtratos.ShowModal;
  setfocus;
end;
...
begin
  ...
  FrmRetornoExtratos.Caption := 'Retorno: Extrato DRC Cobrança';
  FrmRetornoExtratos.ShowModal;
  setfocus;
...
begin
  ...
  AbreBaixa(0);
  FrmExtContaCorrentePoupanca.Caption :='Cartão de Segurança TanCode';
  FrmExtContaCorrentePoupanca.EdRemessa.MaxLength := -1;
  FrmExtContaCorrentePoupanca.ShowModal;
  setfocus;
...
begin
  ...
  FrmRetornoExtratos.Caption := 'Retorno: Extrato Cartão Segurança';
  FrmRetornoExtratos.ShowModal;
  setfocus;
end;
...
begin
  ...
  FrmRetornoExtratos.Caption := 'Retorno: Extrato Cartão Convencional';
  FrmRetornoExtratos.ShowModal;
  setfocus;
end;
...
begin
  ...
  AbreBaixa(4);
  FrmExtContaCorrentePoupanca.Caption :='Baixa de Brindes Secretária';
...
begin
  ...
  //AbreBaixa;
  FrmExtContaCorrentePoupanca.Caption :='Baixa de Código de Ética';
  FrmExtContaCorrentePoupanca.EdRemessa.MaxLength := 20;
  FrmExtContaCorrentePoupanca.DbLkBaixa.Enabled :=  false;
...
begin
  ...
  AbreBaixa(3);
  FrmExtContaCorrentePoupanca.Caption :='Cadastro de Código de Ética';
  FrmExtContaCorrentePoupanca.EdRemessa.MaxLength := 20;
  FrmExtContaCorrentePoupanca.DbLkBaixa.Enabled :=  false;
//  FrmExtContaCorrentePoupanca.DbLkBaixa.Visible :=  false;
  FrmExtContaCorrentePoupanca.ShowModal;
...
begin
  ...
  AbreBaixa(0);
  FrmExtContaCorrentePoupanca.Caption:='Baixa Fatura de Cartão de Crédito';
  FrmExtContaCorrentePoupanca.CheckBox1.Visible := False;
  FrmExtContaCorrentePoupanca.CboBoxTipoBxa.Visible := False;
...
begin
  ...
  FrmRetornoExtratos.Caption := 'Retorno: Baixa Código de Ética';
  FrmRetornoExtratos.ShowModal;
  setfocus;
end;
...
begin
  ...
  FrmRetornoExtratos.Caption := 'Retorno: Cadastro Código de Ética';
  FrmRetornoExtratos.ShowModal;
  setfocus;
...
begin
  ...
  FrmPreCadToken.Caption  :=  'Cadastro Pré-Brindes';
  FrmPreCadToken.ShowModal;
  setfocus;
end;
...
begin
  ...
  FrmPreCadToken.Caption  :=  'Cadastro Pré-TanCode';
  FrmPreCadToken.ShowModal;
  setfocus;
  ...
  with dm do
    begin
      ...
      try SqlServico.Open;
        ...
        begin
          Application.MessageBox(Pchar('Não foi possível Abrir a Tabela de Serviços!'+e.Message),'ADS',64);
          exit;
        end;
      end;
    end;
  ...
  with dm do
    begin
      ...
      try SqlServNLido.Open;
        ...
        begin
          Application.MessageBox(Pchar('Não foi possível Abrir a Tabela de Serviços Não Lidos!'+e.Message),'ADS',64);
          exit;
        end;
      end;
    end;
