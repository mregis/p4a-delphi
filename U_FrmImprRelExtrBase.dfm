object FrmImprRelExtrBase: TFrmImprRelExtrBase
  Left = 0
  Top = 0
  ...
  object MemoDica: TMemo
    ...
    Lines.Strings = (
        ...
        'Preencha os campos de Data Inicial e Data Final abaixo e em segu' +
        'ida '
      'acione o bot'#227'o [Gerar Relat'#243'rio].'
      
        'Se houver dados para que um relat'#243'rio seja criado, ele ser'#225' exib' +
        'ido, do'
      'contr'#225'rio uma mensagem ser'#225' exibida.')
    ParentFont = False
    ReadOnly = True
    TabOrder = 4
  end
